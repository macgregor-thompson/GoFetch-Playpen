...
// use this if you want to match all sub folders:
// '<%= config.src %>/templates/pages/**/*.hbs'
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        assemble: {
            pages: {
                options: {
                    ...
                    sitemap: {
                        homepage: 'http://www.gofetchweb.com',
                        changefreq: 'weekly',
                        priority: '1.0',
        ...
        bootlint: {
            ...
            files: ['<%= config.src %>/templates/{pages,partials}/*hbs'/*, '<%= config.dist %>*//*.hbs','<%= config.dist %>/releaseNotes*//*.hbs','<%= config.dist %>/lync*//*.hbs'*/]
        },
